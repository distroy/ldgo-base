...
func (p *asyncBase[T]) getLen() int   { return p.count.Load() }
func (p *asyncBase[T]) getCap() int   { return p.capacity.Load() }
func (p *asyncBase[T]) setCap(n int)  { p.capacity.Store(n) }
