...
func conveyStoreLoadCompareAndSwapper[I StoreLoadCompareAndSwapper[T], T any](
	c convey.C, fNew func(T) I, values ...T,
) {
...
func testStoreLoadCompareAndSwapper[I StoreLoadCompareAndSwapper[T], T any](
	t *testing.T, fNew func(T) I, values ...T,
) {
	convey.Convey(t.Name(), t, func(c convey.C) {
		conveyStoreLoadCompareAndSwapper(c, fNew, values...)
	})
}
